        ...
        <section className="pt-24 pb-20">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center">
              <div className="inline-block px-4 py-1.5 mb-4 rounded-full text-base font-medium
              ...
              <div className="mb-8 sm:mb-10 space-y-4 sm:space-y-6">
                <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight leading-tight px-4">
                  Elevate Your
                  <br />
                ...
                <p className="text-xl sm:text-2xl md:text-3xl max-w-2xl mx-auto text-gray-400 px-4">
